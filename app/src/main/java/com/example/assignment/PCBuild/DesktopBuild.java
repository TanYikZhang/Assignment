...
public class DesktopBuild extends AppCompatActivity {
    ...
    private void setResult() {
        ...
        PC.setTypePowerSupply(CutRM(psutype));
        PC.setTypeChassis(CutRM(chassistype));
        PC.setTypeMotherBoard(CutRM(motherboardtype));
        ...
        PC.setTypeCoolingSystem(CutRM(coolingsystemtype));
        PC.setTypeCasesLighting(CutRM(caselighttype));
        PC.setTypeWirelessLan(CutRM(wirelesslantype));
